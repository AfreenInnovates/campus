      ...
      {WALLS.map((def) =>
        wallBoxes(def).map((b, i) => (
          ...
          <mesh
            ...
            {/* Baseboard */}
            <mesh position={[b.pos[0], 0.06, b.pos[2]]} visible={evacueeView || !def.cutaway}>
              <boxGeometry args={[
                def.axis === "x" ? b.size[0] : b.size[0] + 0.025,
                0.12,
                def.axis === "z" ? b.size[2] : b.size[2] + 0.025
              ]} />
  ...
  return (
    <group>
      ...
      <group position={[x, 0, z]}>
        <mesh position={def.axis === "z" ? [0, fh / 2, -fw / 2 - frameThickness / 2] : [-fw / 2 - frameThickness / 2, fh / 2, 0]} castShadow>
          <boxGeometry args={def.axis === "z" ? [frameDepth, fh, frameThickness] : [frameThickness, fh, frameDepth]} />
        ...
        <mesh position={[0, fh + frameThickness / 2, 0]} castShadow>
          <boxGeometry args={def.axis === "z" ? [frameDepth, frameThickness, fw + frameThickness * 2] : [fw + frameThickness * 2, frameThickness, frameDepth]} />
          <meshStandardMaterial color="#333" roughness={0.6} metalness={0.2} />
        </mesh>
      </group>
