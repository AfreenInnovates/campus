  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      <mesh position={[0, h, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#3f3833" roughness={0.7} metalness={0.1} />
      </mesh>
      {(
        [
          [-w / 2 + 0.1, -d / 2 + 0.1],
...
export function Monitor({
  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]} scale={scale}>
      ...
      <mesh position={[0, 0.32, 0]} castShadow rotation={[-0.05, 0, 0]}>
        <boxGeometry args={[0.6, 0.34, 0.03]} />
        <meshStandardMaterial color="#141619" roughness={0.5} />
      </mesh>
      <mesh position={[0, 0.32, 0.016]} rotation={[-0.05, 0, 0]}>
...
export function Chair({ position, rotationY = 0 }: P) {
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      ...
      {/* Backrest */}
      <mesh position={[0, 0.75, -0.2]} castShadow rotation={[-0.1, 0, 0]}>
      ...
      <mesh position={[0, 0.04, 0]}>
        <cylinderGeometry args={[0.3, 0.35, 0.03, 12]} />
  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      <mesh position={[0, 0.65, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#2d2f2c" roughness={0.6} metalness={0.2} />
      </mesh>
      {/* Doors */}
      <mesh position={[0.31, 0.65, 0]}>
        <boxGeometry args={[0.02, 1.28, 0.73]} />
        <meshStandardMaterial color="#363935" roughness={0.5} />
      </mesh>
      {/* Handles */}
      {[-0.15, 0.15].map((z, i) => (
        <mesh key={i} position={[0.33, 0.72, z]}>
  ...
  return (
    <group position={position} rotation={[0, rotationY, 0]}>
      <mesh position={[0, 1.0, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#2f3833" roughness={0.6} metalness={0.3} />
      </mesh>
      {[-0.3, 0.3].map((z, i) => (
        <group key={i} position={[0.28, 1.0, z]}>
          <mesh>
            <boxGeometry args={[0.02, 1.95, 0.58]} />
            <meshStandardMaterial color="#36403a" roughness={0.5} metalness={0.1} />
          </mesh>
          <mesh position={[0.02, 0.1, 0.2]}>
