...
function Stick() {
  ...
  return (
    <div
      ref={base}
      aria-label="Move"
      className="pointer-events-auto relative grid h-[132px] w-[132px] touch-none place-items-center rounded-full border-4 border-ink bg-paper shadow-[5px_5px_0_var(--ink)]"
    >
...
function ActionButton({
  ...
  return (
    <button
      ...
      className="pointer-events-auto grid h-[74px] w-[74px] touch-none place-items-center rounded-full border-4 border-ink bg-paper active:scale-95 shadow-[4px_4px_0_var(--ink)]"
    ...
    <div className="pointer-events-none absolute inset-0 z-20 select-none">
      ...
      {prompt && (
        <div className="above-dock pointer-events-none absolute inset-x-0 flex justify-center px-4">
          <div className="border-2 border-ink bg-paper px-3 py-1.5 text-center text-[12px] font-black text-ink shadow-[3px_3px_0_var(--ink)]">
            {prompt}
          </div>
        </div>
      )}
