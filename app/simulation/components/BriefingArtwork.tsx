...
function Logo() {
  return (
    <svg viewBox="0 0 520 240" className="h-full w-full" role="img" aria-label="CampusEvac logo">
      <rect width="520" height="240" fill="#10151d" />
  ...
  return (
    <svg viewBox="0 0 520 240" className="h-full w-full" role="img" aria-label="Campus route map">
      ...
      <path d="M70 183h380M70 58h380M70 58v125M450 58v125" stroke="#283746" strokeWidth="3" />
       <rect x="82" y="76" width="116" height="84" fill="#182a38" stroke={blue} strokeWidth="3" />
       <rect x="322" y="76" width="116" height="84" fill="#2a2634" stroke={yellow} strokeWidth="3" />
       <rect x="214" y="96" width="92" height="44" fill="#20352f" stroke={mint} strokeWidth="3" />
      ...
      <circle cx="417" cy="98" r="8" fill={yellow} />
       <text x="92" y="132" fill="#d9f2ff" fontFamily="monospace" fontSize="11" fontWeight="700">CHEM LAB 1A</text>
       <text x="337" y="132" fill="#fff1b2" fontFamily="monospace" fontSize="11" fontWeight="700">CLASSROOM A201</text>
       <text x="232" y="121" fill="#bbffe3" fontFamily="monospace" fontSize="10" fontWeight="700">CENTRAL</text>
       <text x="221" y="221" fill="#8b99a9" fontFamily="monospace" fontSize="11" letterSpacing="2">MAIN ENTRANCE / ASSEMBLY</text>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 520 240" className="h-full w-full" role="img" aria-label="Mission equipment diagram">
      ...
      <g transform="translate(54 58)">
         <rect width="112" height="112" fill="#182a38" stroke={blue} strokeWidth="3" />
         <rect x="22" y="24" width="68" height="64" fill="#1e2e3b" stroke={blue} strokeWidth="3" />
      ...
      <g transform="translate(204 64)">
         <rect width="98" height="62" fill="#f7cc4b" transform="rotate(-8 49 31)" />
        <rect x="22" y="19" width="54" height="7" rx="3" fill="#5f501e" transform="rotate(-8 49 31)" />
         <rect x="74" y="39" width="12" height="12" fill={red} />
         <text x="3" y="105" fill="#fff1b2" fontFamily="monospace" fontSize="11">LAB ACCESS CARD</text>
      </g>
...
export default function BriefingArtwork({ slide }: BriefingArtworkProps) {
  return (
    <div className="ce-briefing-artwork relative h-40 overflow-hidden sm:h-48">
